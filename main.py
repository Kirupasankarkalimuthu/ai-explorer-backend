    ...
    async with async_playwright() as p:
        ...
        for test_case in test_cases:
                ...
                try:
                    ...
                    if action == "type":
                        ...
                        if page.url != initial_url:
                            ...
                            execution_log.append("✔ URL changed after click")

                        else:

                            execution_log.append("⚠ URL did not change after click")

                except Exception as e:

                    execution_log.append(f"❌ Failed: {action} on {selector} - {str(e)}")

            # Detect validation-like messages dynamically

            validation_texts = await page.evaluate("""
                ...
                () => {
                    ...
                    return Array.from(document.querySelectorAll("*"))
                        ...
                        .filter(text => text && keywords.some(k => text.toLowerCase().includes(k)))
            ...
            if validation_texts:
                ...
                execution_log.append(f"⚠ Validation Messages Detected: {validation_texts}")
